 ...
    , { code: 'zh_tw', language: '中文（繁體）' }
  ...
  var translations = {
    ...
    ,'Time to change cannula' : {
      ...
      ,fr: 'Il est temps de changer le catheter'
    ...
    ,'Change cannula soon' : {
      ...
      ,fr: 'Changement du catheter bientot'
      ,bg: 'Смени сета скоро'
   ...
   ,'Last Carbs' : {
    ...
    ,'Time to change/restart sensor' : {
      ...
      ,fr: 'Il est temps de changer ou redemarrer le capteur'
    ...
    ,'Change/restart sensor soon' : {
      ...
      ,fr: 'Changer ou redemarrer le capteur bientot'
    ...
    ,'Sensor age %1 days %2 hours' : {
      ...
      ,fr: 'Age du Capteur %1 jours %2 heures'
